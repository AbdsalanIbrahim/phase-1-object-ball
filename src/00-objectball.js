    ...
    return {
        home: {
            ...
            players: {
                ...
                "Reggie Evans": { number: 30, shoe: 14, points: 12, rebounds: 12, assists: 10, steals: 2, blocks: 1, slamDunks: 7 },
...
// Test examples in the console
console.log(numPointsScored("Alan Anderson")); // Should log 22
console.log(shoeSize("Brook Lopez")); // Should log 17
